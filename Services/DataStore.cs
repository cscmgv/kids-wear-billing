    ...
    public class DataStore
    {
        ...
        private void SeedInitialData()
        {
            Data = new DataContainer
            {
                ...
                {
                    new Product { Id = "p1", Name = "Baby Soft Cotton Onesie Set (3 Pack)", SKU = "KW-ONS-01", Category = "Onesies", AgeGroup = "0-2Y", Size = "3-6M", Brand = "BabyHug", Price = 499, MRP = 699, CostPrice = 320, TaxRate = 5, Stock = 15, MinLevel = 5, ImageUrl = "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=300" },
                    new Product { Id = "p2", Name = "Little Princess Floral Party Frock", SKU = "KW-FRK-02", Category = "Frocks", AgeGroup = "2-5Y", Size = "2-4Y", Brand = "Lilliput", Price = 899, MRP = 1299, CostPrice = 550, TaxRate = 5, Stock = 1, MinLevel = 5, ImageUrl = "https://images.unsplash.com/photo-1621452773781-0f992fd1f5cb?w=300" },
                    new Product { Id = "p3", Name = "Boys Printed Cartoon Cotton T-Shirt", SKU = "KW-TSH-03", Category = "T-Shirts", AgeGroup = "2-5Y", Size = "4-6Y", Brand = "Hopscotch", Price = 349, MRP = 499, CostPrice = 200, TaxRate = 5, Stock = 24, MinLevel = 6, ImageUrl = "https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=300" },
                    new Product { Id = "p4", Name = "Kids Stretchable Denim Jeans", SKU = "KW-JNS-04", Category = "Jeans", AgeGroup = "5-10Y", Size = "6-8Y", Brand = "Mothercare", Price = 799, MRP = 1099, CostPrice = 480, TaxRate = 5, Stock = 12, MinLevel = 4, ImageUrl = "https://images.unsplash.com/photo-1541216970279-affbfdd55aa8?w=300" },
                    new Product { Id = "p5", Name = "Festive Boys Ethnic Kurta Pyjama Set", SKU = "KW-ETH-05", Category = "Ethnic Wear", AgeGroup = "5-10Y", Size = "8-10Y", Brand = "Manyavar Kids", Price = 1299, MRP = 1799, CostPrice = 800, TaxRate = 12, Stock = 8, MinLevel = 3, ImageUrl = "https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?w=300" },
                    new Product { Id = "p6", Name = "Girls Velvet Winter Hooded Jacket", SKU = "KW-JKT-06", Category = "Party Wear", AgeGroup = "10-16Y", Size = "12-14Y", Brand = "Gini & Jony", Price = 1499, MRP = 1999, CostPrice = 950, TaxRate = 12, Stock = 6, MinLevel = 2, ImageUrl = "https://images.unsplash.com/photo-1503919545889-aef636e10ad4?w=300" },
                    new Product { Id = "p7", Name = "Infant Non-Slip Soft Baby Shoes", SKU = "KW-SHO-07", Category = "Shoes", AgeGroup = "0-2Y", Size = "6-12M", Brand = "FirstStep", Price = 399, MRP = 599, CostPrice = 220, TaxRate = 5, Stock = 18, MinLevel = 5, ImageUrl = "https://images.unsplash.com/photo-1515347619252-60a4bf4fff4f?w=300" },
                    new Product { Id = "p8", Name = "Soft Organic Cotton Nightwear Set", SKU = "KW-NGT-08", Category = "Nightwear", AgeGroup = "2-5Y", Size = "2-4Y", Brand = "BabyHug", Price = 599, MRP = 799, CostPrice = 360, TaxRate = 5, Stock = 10, MinLevel = 4, ImageUrl = "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=300" }
                },
